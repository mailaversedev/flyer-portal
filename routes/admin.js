...
router.get("/credit-requests", authenticateToken, requireSuperAdmin, async (req, res) => {
  try {
...
// POST /api/admin/credit-requests/:id/grant - Grant a credit request
router.post("/credit-requests/:id/grant", authenticateToken, requireSuperAdmin, async (req, res) => {
  try {
    const { id } = req.params;
