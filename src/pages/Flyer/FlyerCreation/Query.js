    ...
    <div className="query-creation">
      <div className="query-container">
        ...
        <div className="step-content">
          {currentStep === 1 && (
            <Step1Background data={queryData} onUpdate={updateQueryData} />
          )}
          {currentStep === 2 && (
            <Step2Survey data={queryData} onUpdate={updateQueryData} />
          )}
          {currentStep === 3 && (
            <TargetBudget data={queryData} onUpdate={updateQueryData} />
          )}
          {currentStep === 4 && (
            <CouponBuilder data={queryData} onUpdate={updateQueryData} />
          )}
        </div>
